...
_Only_dummy_
```
python3 bert_entity/preprocess_all.py --create_integerized_training_valid_size 200 --create_integerized_training_test_size 200 -c config/dummy__preprocess.yaml
```
